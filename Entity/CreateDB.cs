    ...
    public class CreateDB : DropCreateDatabaseAlways<DALQLNH>
    {
        protected override void Seed(DALQLNH context)
        {
            ...
            context.HoaDons.AddRange(new HoaDon[]
            {
                ...
                new HoaDon{ID_HoaDon = 1, ID_User = 1, NgayLap = new DateTime(2022,04,1), TongTien = 1345000},
                new HoaDon{ID_HoaDon = 2, ID_User = 1, NgayLap = new DateTime(2022,04,2), TongTien = 790000},
                new HoaDon{ID_HoaDon = 3, ID_User = 1, NgayLap = new DateTime(2022,04,3), TongTien = 1713000},
                new HoaDon{ID_HoaDon = 4, ID_User = 1, NgayLap = new DateTime(2022,04,4), TongTien = 1378000},
                new HoaDon{ID_HoaDon = 5, ID_User = 1, NgayLap = new DateTime(2022,04,5), TongTien = 1220000},
                new HoaDon{ID_HoaDon = 6, ID_User = 1, NgayLap = new DateTime(2022,04,6), TongTien = 1025000},
                new HoaDon{ID_HoaDon = 7, ID_User = 1, NgayLap = new DateTime(2022,04,7), TongTien = 1844000},
                new HoaDon{ID_HoaDon = 8, ID_User = 1, NgayLap = new DateTime(2022,04,8), TongTien = 1735000},
                new HoaDon{ID_HoaDon = 9, ID_User = 1, NgayLap = new DateTime(2022,04,9), TongTien = 1620000},
                new HoaDon{ID_HoaDon = 10, ID_User = 1, NgayLap = new DateTime(2022,04,10), TongTien = 761000},
                new HoaDon{ID_HoaDon = 11, ID_User = 1, NgayLap = new DateTime(2022,04,11), TongTien = 1789000},

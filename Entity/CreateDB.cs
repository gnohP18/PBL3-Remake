...
namespace Entity
{
    public class CreateDB : DropCreateDatabaseAlways<DALQLNH>
    {
        protected override void Seed(DALQLNH context)
        {
            ...
            {
                new Kho{ID_ChiTietNguyenLieu=1,ID_NguyenLieu = 1,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,19),NgayHetHan = new DateTime(2022,05,19).AddDays(15),LuongNhapVao = 5,LuongTonKho = 2},
                new Kho{ID_ChiTietNguyenLieu=2,ID_NguyenLieu = 1,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,17),NgayHetHan = new DateTime(2022,05,17).AddDays(15),LuongNhapVao = 5,LuongTonKho = 2},
                ...
                new Kho{ID_ChiTietNguyenLieu=4,ID_NguyenLieu = 2,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,18),NgayHetHan = new DateTime(2022,05,18).AddDays(15),LuongNhapVao = 5,LuongTonKho = 2},
                ...
                new Kho{ID_ChiTietNguyenLieu=6,ID_NguyenLieu = 3,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,18),NgayHetHan = new DateTime(2022,05,18).AddDays(15),LuongNhapVao = 5,LuongTonKho = 2},
                ...
                new Kho{ID_ChiTietNguyenLieu=8,ID_NguyenLieu = 4,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,20),NgayHetHan = new DateTime(2022,05,20).AddDays(30),LuongNhapVao = 5,LuongTonKho = 2},
                new Kho{ID_ChiTietNguyenLieu=9,ID_NguyenLieu = 4,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,25),NgayHetHan = new DateTime(2022,05,25).AddDays(30),LuongNhapVao = 5,LuongTonKho = 2},
                new Kho{ID_ChiTietNguyenLieu=10,ID_NguyenLieu = 5,ID_NhaCungCap = 4,NgayNhap = new DateTime(2022,05,18),NgayHetHan = new DateTime(2022,05,18).AddDays(7),LuongNhapVao = 5,LuongTonKho = 2},
                ...
                new Kho{ID_ChiTietNguyenLieu=12,ID_NguyenLieu = 6,ID_NhaCungCap = 7,NgayNhap = new DateTime(2022,05,20),NgayHetHan = new DateTime(2022,05,20).AddDays(7),LuongNhapVao = 5,LuongTonKho = 30},
                ...
                new Kho{ID_ChiTietNguyenLieu=14,ID_NguyenLieu = 7,ID_NhaCungCap = 6,NgayNhap = new DateTime(2022,05,18),NgayHetHan = new DateTime(2022,05,18).AddDays(2),LuongNhapVao = 5,LuongTonKho = 30},
                ...
                new Kho{ID_ChiTietNguyenLieu=16,ID_NguyenLieu = 8,ID_NhaCungCap = 5,NgayNhap = new DateTime(2022,05,18),NgayHetHan = new DateTime(2022,05,18).AddDays(30),LuongNhapVao = 5,LuongTonKho = 30},
                ...
                new Kho{ID_ChiTietNguyenLieu=18,ID_NguyenLieu = 9,ID_NhaCungCap = 6,NgayNhap = new DateTime(2022,05,18),NgayHetHan = new DateTime(2022,05,18).AddDays(365),LuongNhapVao = 6,LuongTonKho = 1},
                new Kho{ID_ChiTietNguyenLieu=19,ID_NguyenLieu = 9,ID_NhaCungCap = 7,NgayNhap = new DateTime(2022,05,20),NgayHetHan = new DateTime(2022,05,20).AddDays(365),LuongNhapVao = 6,LuongTonKho = 2},
                new Kho{ID_ChiTietNguyenLieu=20,ID_NguyenLieu = 2,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,18),NgayHetHan = new DateTime(2022,05,18).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=21,ID_NguyenLieu = 2,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,20),NgayHetHan = new DateTime(2022,05,20).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=22,ID_NguyenLieu = 2,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,04,27),NgayHetHan = new DateTime(2022,04,27).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=23,ID_NguyenLieu = 2,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,04,28),NgayHetHan = new DateTime(2022,04,28).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=24,ID_NguyenLieu = 2,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,04,29),NgayHetHan = new DateTime(2022,04,29).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=25,ID_NguyenLieu = 3,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,04,30),NgayHetHan = new DateTime(2022,04,30).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=26,ID_NguyenLieu = 3,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,01),NgayHetHan = new DateTime(2022,05,01).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=27,ID_NguyenLieu = 3,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,02),NgayHetHan = new DateTime(2022,05,02).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=28,ID_NguyenLieu = 3,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,03),NgayHetHan = new DateTime(2022,05,03).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=29,ID_NguyenLieu = 3,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,04),NgayHetHan = new DateTime(2022,05,04).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=30,ID_NguyenLieu = 3,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,05),NgayHetHan = new DateTime(2022,05,05).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=31,ID_NguyenLieu = 3,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,06),NgayHetHan = new DateTime(2022,05,06).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=32,ID_NguyenLieu = 3,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,07),NgayHetHan = new DateTime(2022,05,07).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=33,ID_NguyenLieu = 21,ID_NhaCungCap = 10,NgayNhap = new DateTime(2022,05,08),NgayHetHan = new DateTime(2022,05,08).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=34,ID_NguyenLieu = 21,ID_NhaCungCap = 10,NgayNhap = new DateTime(2022,05,09),NgayHetHan = new DateTime(2022,05,09).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=35,ID_NguyenLieu = 21,ID_NhaCungCap = 10,NgayNhap = new DateTime(2022,05,10),NgayHetHan = new DateTime(2022,05,10).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=36,ID_NguyenLieu = 21,ID_NhaCungCap = 10,NgayNhap = new DateTime(2022,05,11),NgayHetHan = new DateTime(2022,05,11).AddDays(15),LuongNhapVao = 7,LuongTonKho = 8},
                new Kho{ID_ChiTietNguyenLieu=37,ID_NguyenLieu = 21,ID_NhaCungCap = 10,NgayNhap = new DateTime(2022,05,12),NgayHetHan = new DateTime(2022,05,12).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4},
                ...
                new Kho{ID_ChiTietNguyenLieu=41,ID_NguyenLieu = 1,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,16),NgayHetHan = new DateTime(2022,05,16).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=42,ID_NguyenLieu = 1,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,17),NgayHetHan = new DateTime(2022,05,17).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=43,ID_NguyenLieu = 1,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,18),NgayHetHan = new DateTime(2022,05,18).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4 },
                new Kho{ID_ChiTietNguyenLieu=44,ID_NguyenLieu = 1,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,19),NgayHetHan = new DateTime(2022,05,19).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=45,ID_NguyenLieu = 1,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,20),NgayHetHan = new DateTime(2022,05,20).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=46,ID_NguyenLieu = 1,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,21),NgayHetHan = new DateTime(2022,05,21).AddDays(15),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=47,ID_NguyenLieu = 4,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,22),NgayHetHan = new DateTime(2022,05,22).AddDays(7),LuongNhapVao = 7,LuongTonKho = 6},
                new Kho{ID_ChiTietNguyenLieu=48,ID_NguyenLieu = 4,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,23),NgayHetHan = new DateTime(2022,05,23).AddDays(7),LuongNhapVao = 7,LuongTonKho = 6},
                new Kho{ID_ChiTietNguyenLieu=49,ID_NguyenLieu = 4,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,24),NgayHetHan = new DateTime(2022,05,24).AddDays(7),LuongNhapVao = 7,LuongTonKho = 6},
                new Kho{ID_ChiTietNguyenLieu=50,ID_NguyenLieu = 4,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,25),NgayHetHan = new DateTime(2022,05,25).AddDays(7),LuongNhapVao = 7,LuongTonKho = 6},
            });
            ...
            context.HoaDons.AddRange(new HoaDon[]
            {
                ...
                new HoaDon{ID_HoaDon = 32, ID_User = 2, NgayLap = new DateTime(2022,04,27), TongTien = 324000},
                new HoaDon{ID_HoaDon = 33, ID_User = 2, NgayLap = new DateTime(2022,04,29), TongTien = 268000},
                new HoaDon{ID_HoaDon = 34, ID_User = 2, NgayLap = new DateTime(2022,04,30), TongTien = 441000},
                ...
                new HoaDon{ID_HoaDon = 37, ID_User = 2, NgayLap = new DateTime(2022,05,12), TongTien = 661000},
                new HoaDon{ID_HoaDon = 38, ID_User = 2, NgayLap = new DateTime(2022,05,12), TongTien = 770000},
                new HoaDon{ID_HoaDon = 39, ID_User = 2, NgayLap = new DateTime(2022,05,12), TongTien = 779000},
                new HoaDon{ID_HoaDon = 40, ID_User = 2, NgayLap = new DateTime(2022,05,12), TongTien = 900000},
                new HoaDon{ID_HoaDon = 41, ID_User = 2, NgayLap = new DateTime(2022,05,12), TongTien = 810000},
            });

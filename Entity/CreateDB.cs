    ...
    public class CreateDB : DropCreateDatabaseAlways<DALQLNH>
    {
        protected override void Seed(DALQLNH context)
        {
            ...
            context.Khoes.AddRange(new Kho[]
            {
                ...
                new Kho{ID_ChiTietNguyenLieu=20,ID_NguyenLieu = 10,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,18),NgayHetHan = new DateTime(2022,05,18).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=21,ID_NguyenLieu = 11,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,20),NgayHetHan = new DateTime(2022,05,20).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=22,ID_NguyenLieu = 12,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,04,27),NgayHetHan = new DateTime(2022,04,27).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                new Kho{ID_ChiTietNguyenLieu=23,ID_NguyenLieu = 13,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,04,28),NgayHetHan = new DateTime(2022,04,28).AddDays(15),LuongNhapVao = 6,LuongTonKho = 3},
                ...
                new Kho{ID_ChiTietNguyenLieu=28,ID_NguyenLieu = 16,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,03),NgayHetHan = new DateTime(2022,05,03).AddDays(365),LuongNhapVao = 6,LuongTonKho = 3},
                ...
                new Kho{ID_ChiTietNguyenLieu=32,ID_NguyenLieu = 18,ID_NhaCungCap = 2,NgayNhap = new DateTime(2022,05,07),NgayHetHan = new DateTime(2022,05,07).AddDays(2),LuongNhapVao = 6,LuongTonKho = 3},
                ...
                new Kho{ID_ChiTietNguyenLieu=34,ID_NguyenLieu = 19,ID_NhaCungCap = 10,NgayNhap = new DateTime(2022,05,09),NgayHetHan = new DateTime(2022,05,09).AddDays(365),LuongNhapVao = 7,LuongTonKho = 4},
                ...
                new Kho{ID_ChiTietNguyenLieu=36,ID_NguyenLieu = 20,ID_NhaCungCap = 10,NgayNhap = new DateTime(2022,05,11),NgayHetHan = new DateTime(2022,05,11).AddDays(365),LuongNhapVao = 7,LuongTonKho = 8},
                ...
                new Kho{ID_ChiTietNguyenLieu=41,ID_NguyenLieu = 22,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,16),NgayHetHan = new DateTime(2022,05,16).AddDays(2),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=42,ID_NguyenLieu = 22,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,17),NgayHetHan = new DateTime(2022,05,17).AddDays(2),LuongNhapVao = 7,LuongTonKho = 4},
                ...
                new Kho{ID_ChiTietNguyenLieu=44,ID_NguyenLieu = 23,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,19),NgayHetHan = new DateTime(2022,05,19).AddDays(90),LuongNhapVao = 7,LuongTonKho = 4},
                ...
                new Kho{ID_ChiTietNguyenLieu=46,ID_NguyenLieu = 30,ID_NhaCungCap = 1,NgayNhap = new DateTime(2022,05,21),NgayHetHan = new DateTime(2022,05,21).AddDays(7),LuongNhapVao = 7,LuongTonKho = 4},
                new Kho{ID_ChiTietNguyenLieu=47,ID_NguyenLieu = 31,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,22),NgayHetHan = new DateTime(2022,05,22).AddDays(7),LuongNhapVao = 7,LuongTonKho = 6},
                new Kho{ID_ChiTietNguyenLieu=48,ID_NguyenLieu = 32,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,23),NgayHetHan = new DateTime(2022,05,23).AddDays(1),LuongNhapVao = 7,LuongTonKho = 6},
                new Kho{ID_ChiTietNguyenLieu=49,ID_NguyenLieu = 33,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,24),NgayHetHan = new DateTime(2022,05,24).AddDays(1),LuongNhapVao = 7,LuongTonKho = 6},
                new Kho{ID_ChiTietNguyenLieu=50,ID_NguyenLieu = 34,ID_NhaCungCap = 3,NgayNhap = new DateTime(2022,05,25),NgayHetHan = new DateTime(2022,05,25).AddDays(20),LuongNhapVao = 7,LuongTonKho = 6},
            });

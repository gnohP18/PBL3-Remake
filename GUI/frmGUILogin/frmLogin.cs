        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            if (radEmployee.Checked)
            {
                ...
                if (CheckLogin == -1)
                {
                    ...
                    txtUsername.IconRight = Properties.Resources.uncheckedRed;
                    txtPassword.IconRight = Properties.Resources.uncheckedRed;
                    box.Show();
                    return;
                }
                if (CheckLogin == 0)
                ...
                if (CheckLogin == 1)
                {
                    ...
                    txtUsername.IconRight = Properties.Resources.checkedGreen;
                    txtPassword.IconRight = Properties.Resources.checkedGreen;
                    frm.Show();
                    frm.Owner = this;
                    this.Hide();
                }

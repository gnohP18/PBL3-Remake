...
namespace PBL3_Remake.GUI.CustomItem
{
    internal class CustomDateTimePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.LightCalendar;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.DarkCalendar;
                else calendarIcon = Properties.Resources.LightCalendar;
                this.Invalidate();
            }
        }

...
namespace GUI.frmGUIUserControl
{
    ...
    {   int MA { get; set; }
        ...
        {
            cbbIngrendients.Items.AddRange(NguyenLieuBLL.Instance.GetListNguyenLieuByIdLoaiNguyenLieu(((LoaiNguyenLieu)cbbKindOfIngredinet.SelectedItem).ID_LoaiNguyenLieu).ToArray());
        }
